...
import { BarChart3, Users, BookOpen, Award, TrendingUp, AlertCircle, Settings } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
            ...
            <p className="text-xs text-purple-200 mt-1">+8% from last month</p>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { action: 'Course published', user: 'Jane Smith', time: '1 hour ago' },
              { action: 'Certificate issued', user: 'Bob Wilson', time: '2 hours ago' },
              { action: 'User enrolled in course', user: 'Alice Brown', time: '3 hours ago' }
            ].map((activity, index) => (
